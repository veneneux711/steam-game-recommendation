...
def played_games_frame(root, played_games_dict):
    ...
    played_games_label = tk.Label(played_games_frame, text='Your Ratings:', 
                                  font=('Arial', 14, 'bold'), fg='green')
    played_games_label.grid(row=0, column=0)

    played_games_listbox = tk.Listbox(played_games_frame, width=120, height=6, font=('Arial', 10))
...
def fav_games_frame(root, fav_games_dict):
    ...
    fav_games_label = tk.Label(fav_games_frame, text='Favourite Games:', 
                               font=('Arial', 14, 'bold'), fg='orange')
    fav_games_label.grid(row=0, column=0)

    fav_games_listbox = tk.Listbox(fav_games_frame, width=120, height=5, font=('Arial', 10))
    ...
    delete_fav_button = tk.Button(fav_games_frame, text='Delete Favourite', 
                                  command=lambda: commands.remove_favourite(fav_games_listbox, fav_games_dict), 
                                  font=('Arial', 11), bg='lightgray')
    delete_fav_button.grid(row=3, column=0, padx=10, pady=5)
...
def check_review_frame(root, played_games_frame, played_games_dict, fav_games_frame, fav_games_dict):
    ...
    delete_review_button = tk.Button(check_review_frame, text='Delete Rating', 
                                    command=lambda: commands.remove_review(played_games_listbox,played_games_dict), 
                                    font=('Arial', 11), bg='lightgray')
    delete_review_button.grid(row=0, column=1, padx=5)

    fav_button = tk.Button(check_review_frame, text='Mark as Favourite', 
    ...
    fav_button.grid(row=0, column=2, padx=5)
...
def rating_frame(root,games_frame,played_games_frame,played_games_dict):
    ...
    like_button = tk.Button(rating_frame, text='Like', 
    ...
    interested_button = tk.Button(rating_frame, text='Interested', 
    ...
    interested_button.grid(row=0, column=2, padx=5)

    neutral_button = tk.Button(rating_frame, text='Neutral/Not Interested', 
    ...
    dislike_button = tk.Button(rating_frame, text='Dislike', 
    ...
    dislike_button.grid(row=0, column=4, padx=5)
...
def rcm_frame(root,played_games_dict, fav_games_dict, dir_path, df_all):
    ...
    confirm_button = tk.Button(recommendations_frame, text='Save Ratings', 
    ...
    recommendations_button = tk.Button(recommendations_frame, text='Get Recommendations', 
